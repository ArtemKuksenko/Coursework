...
module.exports = function parserToMariadb(timeStartI, timeEndI, stepI, baseI, intervalI, tableNameI){
	
	const minute = 60000;

	let timeStart = timeStartI || 1514764800000; // Mon, 01 Jan 2018 00:00:00 GMT
	let timeEnd   = timeEndI   || 1546300800000; // Mon, 01 Jan 2019 00:00:00 GMT
	let step      = stepI      || minute * 60 *24 *6;
	let interval  = intervalI  || "m15";
	let base      = baseI      || "tron";
	let tableName = tableNameI || "tron_m15";
